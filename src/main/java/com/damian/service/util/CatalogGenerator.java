...
//
//        String theme = catalog.getCatalogDetails().getCatalogTheme();
//
...
//
//               // List<BasketItems> bi = basket.getBasketItems();
//
//
//                int hPosition = 430;
...
//
//        Text catalogLastPageInfo = new Text(catalog.getCatalogDetails().getCatalogLastPageDesc())
//            .setFont(fontRobotoRegular)
//            .setFontSize(17)
//            .setFontColor(dSzary)
//            .setTextAlignment(TextAlignment.CENTER)
